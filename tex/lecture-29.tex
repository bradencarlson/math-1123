...
\content{
        \begin{example} Encrypt the message ``Lets meet at midnight'' using a
        transposition cipher with secret key ``secret''.
        \end{example}
}{% presentation
\vspace{3in}
}{% nopresentation
...
\content{
        \begin{example} Here is a message which was encrypted using a
        transposition cipher with secret key ``power''. What was the message?

        \texttt{FIYIUHAEFLTNVIUISDCEELRFT}
        \end{example}
}{% presentation
\vspace{3in}
}{% nopresentation
