...
\begin{document}
{\large\bf Puzzles}\hfill Name: \underline{\hspace{2in}} \\

Talk about these mathematical puzzles with a neighbor or in a small group. If
...
value of $w$? What does that mean about the amount of `non-water' in the field?)
